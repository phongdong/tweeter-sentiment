...
var tweeter = new twitter({
    consumer_key: '0a1ZAOFbD02sJvGvGjkwtzA9u',
    consumer_secret: 'VUoFZD4OYrEb3ZX2KLBPRiN9pZnCQ7EPPh7M2tJArrN7LqJRAz',
    access_token_key: '602311663-Nf4d7HHk4tfq8XHd8YC4ms2V30duhWVAICFIY19J',
    access_token_secret: 'lgBkW90W33ms2AEoTRtCYpOTEWZ5CppFyPLXxLsMM74sk'
});
...
function beginMonitoring(phrase) {
    ...
    tweeter.get('account/verify_credentials', function (error, data) {
        if (error) {
        	resetMonitoring();
